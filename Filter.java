...
public class Filter {
    public static void main(String[] args) {
        ...
        FinalHW l1 = new FinalHW(1, 2, 128, "Windows 10", "Сиреневый");
        FinalHW l2 = new FinalHW(2, 4, 256, "Windows 11", "Красный");
        FinalHW l3 = new FinalHW(3, 32, 512, "Windows 10", "Серый");
        FinalHW l4 = new FinalHW(4, 16, 256, "Windows 11", "Черный");
